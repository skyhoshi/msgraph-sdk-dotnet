...
namespace Microsoft.Graph
{
    ...
    /// <summary>
    /// The type ManagedEBookReferenceRequest.
    /// </summary>
    public partial class ManagedEBookReferenceRequest : BaseRequest, IManagedEBookReferenceRequest
    {
        /// <summary>
        /// Constructs a new ManagedEBookReferenceRequest.
        /// </summary>
        /// <param name="requestUrl">The URL for the built request.</param>
        /// <param name="client">The <see cref="IBaseClient"/> for handling requests.</param>
        /// <param name="options">Query and header option name value pairs for the request.</param>
        public ManagedEBookReferenceRequest(
            string requestUrl,
            IBaseClient client,
        ...
        /// <summary>
        /// Deletes the specified ManagedEBook reference.
        /// </summary>
        ...
        /// <summary>
        /// Puts the specified ManagedEBook reference.
        /// </summary>
        /// <param name="id">The ManagedEBook reference to update.</param>
        /// <returns>The task to await.</returns>
