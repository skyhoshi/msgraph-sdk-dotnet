    ...
    public partial class DefaultManagedAppProtectionRequest : BaseRequest, IDefaultManagedAppProtectionRequest
    {
        ...
        private void InitializeCollectionProperties(DefaultManagedAppProtection defaultManagedAppProtectionToInitialize)
        {
            ...
            if (defaultManagedAppProtectionToInitialize != null && defaultManagedAppProtectionToInitialize.AdditionalData != null)
            {
                ...
                if (defaultManagedAppProtectionToInitialize.MobileAppIdentifierDeployments != null && defaultManagedAppProtectionToInitialize.MobileAppIdentifierDeployments.CurrentPage != null)
                {
                    defaultManagedAppProtectionToInitialize.MobileAppIdentifierDeployments.AdditionalData = defaultManagedAppProtectionToInitialize.AdditionalData;

                    object nextPageLink;
                    defaultManagedAppProtectionToInitialize.AdditionalData.TryGetValue("mobileAppIdentifierDeployments@odata.nextLink", out nextPageLink);
                    var nextPageLinkString = nextPageLink as string;

                    if (!string.IsNullOrEmpty(nextPageLinkString))
                    {
                        defaultManagedAppProtectionToInitialize.MobileAppIdentifierDeployments.InitializeNextPageRequest(
                            this.Client,
                            nextPageLinkString);
                    }
                }
