...
namespace Microsoft.Graph
{
    ...
    public partial class ChatThreadRequestBuilder : EntityRequestBuilder, IChatThreadRequestBuilder
    {
        ...
        /// <summary>
        /// Gets the request builder for ChatMessages.
        /// </summary>
        /// <returns>The <see cref="IChatThreadChatMessagesCollectionRequestBuilder"/>.</returns>
        public IChatThreadChatMessagesCollectionRequestBuilder ChatMessages
        {
            get
            {
                return new ChatThreadChatMessagesCollectionRequestBuilder(this.AppendSegmentToRequestUrl("chatMessages"), this.Client);
            }
        }
