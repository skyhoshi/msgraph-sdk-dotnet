...
namespace Microsoft.Graph
{
    ...
    public partial class ManagedEBookAssignRequestBuilder : BaseActionMethodRequestBuilder<IManagedEBookAssignRequest>, IManagedEBookAssignRequestBuilder
    {
        ...
        /// <param name="eBookGroupAssignments">A eBookGroupAssignments parameter for the OData method call.</param>
        public ManagedEBookAssignRequestBuilder(
            string requestUrl,
            IBaseClient client,
            IEnumerable<EBookGroupAssignment> eBookGroupAssignments)
            : base(requestUrl, client)
        {
            this.SetParameter("eBookGroupAssignments", eBookGroupAssignments, true);
        }
        ...
        protected override IManagedEBookAssignRequest CreateRequest(string functionUrl, IEnumerable<Option> options)
        {
            ...
            if (this.HasParameter("eBookGroupAssignments"))
            {
                request.RequestBody.EBookGroupAssignments = this.GetParameter<IEnumerable<EBookGroupAssignment>>("eBookGroupAssignments");
            }
