    ...
    public partial class ManagedEBookRequest : BaseRequest, IManagedEBookRequest
    {
        ...
        private void InitializeCollectionProperties(ManagedEBook managedEBookToInitialize)
        {
            ...
            if (managedEBookToInitialize != null && managedEBookToInitialize.AdditionalData != null)
            {
                ...
                if (managedEBookToInitialize.GroupAssignments != null && managedEBookToInitialize.GroupAssignments.CurrentPage != null)
                {
                    managedEBookToInitialize.GroupAssignments.AdditionalData = managedEBookToInitialize.AdditionalData;

                    object nextPageLink;
                    managedEBookToInitialize.AdditionalData.TryGetValue("groupAssignments@odata.nextLink", out nextPageLink);
                    var nextPageLinkString = nextPageLink as string;

                    if (!string.IsNullOrEmpty(nextPageLinkString))
                    {
                        managedEBookToInitialize.GroupAssignments.InitializeNextPageRequest(
                            this.Client,
                            nextPageLinkString);
                    }
                }
