    ...
    public partial class TargetedManagedAppConfigurationRequest : BaseRequest, ITargetedManagedAppConfigurationRequest
    {
        ...
        private void InitializeCollectionProperties(TargetedManagedAppConfiguration targetedManagedAppConfigurationToInitialize)
        {
            ...
            if (targetedManagedAppConfigurationToInitialize != null && targetedManagedAppConfigurationToInitialize.AdditionalData != null)
            {
                ...
                if (targetedManagedAppConfigurationToInitialize.MobileAppIdentifierDeployments != null && targetedManagedAppConfigurationToInitialize.MobileAppIdentifierDeployments.CurrentPage != null)
                {
                    targetedManagedAppConfigurationToInitialize.MobileAppIdentifierDeployments.AdditionalData = targetedManagedAppConfigurationToInitialize.AdditionalData;

                    object nextPageLink;
                    targetedManagedAppConfigurationToInitialize.AdditionalData.TryGetValue("mobileAppIdentifierDeployments@odata.nextLink", out nextPageLink);
                    var nextPageLinkString = nextPageLink as string;

                    if (!string.IsNullOrEmpty(nextPageLinkString))
                    {
                        targetedManagedAppConfigurationToInitialize.MobileAppIdentifierDeployments.InitializeNextPageRequest(
                            this.Client,
                            nextPageLinkString);
                    }
                }
