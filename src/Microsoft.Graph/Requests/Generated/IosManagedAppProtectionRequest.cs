    ...
    public partial class IosManagedAppProtectionRequest : BaseRequest, IIosManagedAppProtectionRequest
    {
        ...
        private void InitializeCollectionProperties(IosManagedAppProtection iosManagedAppProtectionToInitialize)
        {
            ...
            if (iosManagedAppProtectionToInitialize != null && iosManagedAppProtectionToInitialize.AdditionalData != null)
            {
                ...
                if (iosManagedAppProtectionToInitialize.MobileAppIdentifierDeployments != null && iosManagedAppProtectionToInitialize.MobileAppIdentifierDeployments.CurrentPage != null)
                {
                    iosManagedAppProtectionToInitialize.MobileAppIdentifierDeployments.AdditionalData = iosManagedAppProtectionToInitialize.AdditionalData;

                    object nextPageLink;
                    iosManagedAppProtectionToInitialize.AdditionalData.TryGetValue("mobileAppIdentifierDeployments@odata.nextLink", out nextPageLink);
                    var nextPageLinkString = nextPageLink as string;

                    if (!string.IsNullOrEmpty(nextPageLinkString))
                    {
                        iosManagedAppProtectionToInitialize.MobileAppIdentifierDeployments.InitializeNextPageRequest(
                            this.Client,
                            nextPageLinkString);
                    }
                }
