...
namespace Microsoft.Graph
{
    ...
    public partial class DeviceConfiguration : Entity
    {
        ...
        /// <summary>
        /// Gets or sets assignment progress.
        /// </summary>
        [JsonProperty(NullValueHandling = NullValueHandling.Ignore, PropertyName = "assignmentProgress", Required = Newtonsoft.Json.Required.Default)]
        public string AssignmentProgress { get; set; }
    
        /// <summary>
        /// Gets or sets assignment error message.
        /// </summary>
        [JsonProperty(NullValueHandling = NullValueHandling.Ignore, PropertyName = "assignmentErrorMessage", Required = Newtonsoft.Json.Required.Default)]
        public string AssignmentErrorMessage { get; set; }
