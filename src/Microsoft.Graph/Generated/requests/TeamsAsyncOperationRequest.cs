...
namespace Microsoft.Graph
{
    ...
    public partial class TeamsAsyncOperationRequest : BaseRequest, ITeamsAsyncOperationRequest
    {
        ...
        /// </summary>
        /// <returns>The <see cref="GraphResponse{TeamsAsyncOperation}"/> object of the request.</returns>
        public System.Threading.Tasks.Task<GraphResponse<TeamsAsyncOperation>> GetResponseAsync()
        {
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The <see cref="GraphResponse{TeamsAsyncOperation}"/> object of the request.</returns>
        public async System.Threading.Tasks.Task<GraphResponse<TeamsAsyncOperation>> GetResponseAsync(CancellationToken cancellationToken)
        {
            this.Method = "GET";
            return await this.SendAsyncWithGraphResponse<TeamsAsyncOperation>(null, cancellationToken).ConfigureAwait(false);
        }
