...
namespace Microsoft.Graph
{
    ...
    public partial interface IFido2AuthenticationMethodConfigurationIncludeTargetsCollectionRequest : IBaseRequest
    {
        ...
        System.Threading.Tasks.Task<GraphResponse<Fido2AuthenticationMethodConfigurationIncludeTargetsCollectionResponse>> GetResponseAsync();
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The <see cref="GraphResponse{Fido2AuthenticationMethodConfigurationIncludeTargetsCollectionResponse}"/> object.</returns>
        System.Threading.Tasks.Task<GraphResponse<Fido2AuthenticationMethodConfigurationIncludeTargetsCollectionResponse>> GetResponseAsync(CancellationToken cancellationToken);
