...
namespace Microsoft.Graph
{
    ...
    public partial class OnenoteSectionRequest : BaseRequest, IOnenoteSectionRequest
    {
        ...
        /// </summary>
        /// <returns>The <see cref="GraphResponse{OnenoteSection}"/> object of the request.</returns>
        public System.Threading.Tasks.Task<GraphResponse<OnenoteSection>> GetResponseAsync()
        {
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The <see cref="GraphResponse{OnenoteSection}"/> object of the request.</returns>
        public async System.Threading.Tasks.Task<GraphResponse<OnenoteSection>> GetResponseAsync(CancellationToken cancellationToken)
        {
            this.Method = "GET";
            return await this.SendAsyncWithGraphResponse<OnenoteSection>(null, cancellationToken).ConfigureAwait(false);
        }
