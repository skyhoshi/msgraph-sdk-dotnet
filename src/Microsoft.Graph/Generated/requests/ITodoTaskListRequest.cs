...
namespace Microsoft.Graph
{
    ...
    /// </summary>
    public partial interface ITodoTaskListRequest : IBaseRequest
    {
        /// <summary>
        ...
        System.Threading.Tasks.Task<TodoTaskList> GetAsync();
        ...
        System.Threading.Tasks.Task<TodoTaskList> UpdateAsync(TodoTaskList todoTaskListToUpdate);
        ...
        /// <returns>The updated TodoTaskList.</returns>
        System.Threading.Tasks.Task<TodoTaskList> UpdateAsync(TodoTaskList todoTaskListToUpdate, CancellationToken cancellationToken);
        ...
        /// <param name="todoTaskListToUpdate">The TodoTaskList to update.</param>
        /// <returns>The <see cref="GraphResponse{TodoTaskList}"/> object of the request.</returns>
        System.Threading.Tasks.Task<GraphResponse<TodoTaskList>> UpdateResponseAsync(TodoTaskList todoTaskListToUpdate);
        ...
        /// <exception cref="ClientException">Thrown when an object returned in a response is used for updating an object in Microsoft Graph.</exception>
        /// <returns>The <see cref="GraphResponse{TodoTaskList}"/> object of the request.</returns>
        System.Threading.Tasks.Task<GraphResponse<TodoTaskList>> UpdateResponseAsync(TodoTaskList todoTaskListToUpdate, CancellationToken cancellationToken);
        ...
        ITodoTaskListRequest Expand(string value);
        ...
        /// <returns>The request object to send.</returns>
        ITodoTaskListRequest Expand(Expression<Func<TodoTaskList, object>> expandExpression);
        ...
        /// <returns>The request object to send.</returns>
        ITodoTaskListRequest Select(string value);
        ...
        /// <returns>The request object to send.</returns>
        ITodoTaskListRequest Select(Expression<Func<TodoTaskList, object>> selectExpression);
