...
namespace Microsoft.Graph
{
    ...
    public partial class PostExtensionsCollectionRequest : BaseRequest, IPostExtensionsCollectionRequest
    {
        ...
        public System.Threading.Tasks.Task<GraphResponse<PostExtensionsCollectionResponse>> GetResponseAsync()
        {
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The <see cref="GraphResponse{PostExtensionsCollectionResponse}"/> object.</returns>
        public async System.Threading.Tasks.Task<GraphResponse<PostExtensionsCollectionResponse>> GetResponseAsync(CancellationToken cancellationToken)
        {
            this.Method = "GET";
