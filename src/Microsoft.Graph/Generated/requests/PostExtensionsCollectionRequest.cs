...
namespace Microsoft.Graph
{
    ...
    public partial class PostExtensionsCollectionRequest : BaseRequest, IPostExtensionsCollectionRequest
    {
        ...
        public async System.Threading.Tasks.Task<IPostExtensionsCollectionPage> GetAsync(CancellationToken cancellationToken = default(CancellationToken))
        {
            this.Method = "GET";
        ...
        public async System.Threading.Tasks.Task<GraphResponse<PostExtensionsCollectionResponse>> GetResponseAsync(CancellationToken cancellationToken = default(CancellationToken))
        {
            this.Method = "GET";
            return await this.SendAsyncWithGraphResponse<PostExtensionsCollectionResponse>(null, cancellationToken).ConfigureAwait(false);
        }
