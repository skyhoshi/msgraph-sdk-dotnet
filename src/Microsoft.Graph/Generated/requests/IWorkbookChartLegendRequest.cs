...
namespace Microsoft.Graph
{
    ...
    public partial interface IWorkbookChartLegendRequest : IBaseRequest
    {
        ...
        /// <param name="workbookChartLegendToUpdate">The WorkbookChartLegend to update.</param>
        /// <returns>The <see cref="GraphResponse{WorkbookChartLegend}"/> object of the request.</returns>
        System.Threading.Tasks.Task<GraphResponse<WorkbookChartLegend>> UpdateResponseAsync(WorkbookChartLegend workbookChartLegendToUpdate);
        ...
        /// <exception cref="ClientException">Thrown when an object returned in a response is used for updating an object in Microsoft Graph.</exception>
        /// <returns>The <see cref="GraphResponse{WorkbookChartLegend}"/> object of the request.</returns>
        System.Threading.Tasks.Task<GraphResponse<WorkbookChartLegend>> UpdateResponseAsync(WorkbookChartLegend workbookChartLegendToUpdate, CancellationToken cancellationToken);
