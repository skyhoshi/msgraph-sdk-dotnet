...
namespace Microsoft.Graph
{
    ...
    public partial class CalendarEventsCollectionRequest : BaseRequest, ICalendarEventsCollectionRequest
    {
        ...
        public async System.Threading.Tasks.Task<ICalendarEventsCollectionPage> GetAsync(CancellationToken cancellationToken = default(CancellationToken))
        {
            this.Method = "GET";
        ...
        public async System.Threading.Tasks.Task<GraphResponse<CalendarEventsCollectionResponse>> GetResponseAsync(CancellationToken cancellationToken = default(CancellationToken))
        {
            this.Method = "GET";
            return await this.SendAsyncWithGraphResponse<CalendarEventsCollectionResponse>(null, cancellationToken).ConfigureAwait(false);
        }
