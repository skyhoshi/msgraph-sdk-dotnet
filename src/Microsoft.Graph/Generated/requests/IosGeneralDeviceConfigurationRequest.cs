...
namespace Microsoft.Graph
{
    ...
    public partial class IosGeneralDeviceConfigurationRequest : BaseRequest, IIosGeneralDeviceConfigurationRequest
    {
        ...
        public System.Threading.Tasks.Task<GraphResponse<IosGeneralDeviceConfiguration>> CreateResponseAsync(IosGeneralDeviceConfiguration iosGeneralDeviceConfigurationToCreate)
        {
            return this.CreateResponseAsync(iosGeneralDeviceConfigurationToCreate, CancellationToken.None);
        }
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The <see cref="GraphResponse{IosGeneralDeviceConfiguration}"/> object of the request.</returns>
        public async System.Threading.Tasks.Task<GraphResponse<IosGeneralDeviceConfiguration>> CreateResponseAsync(IosGeneralDeviceConfiguration iosGeneralDeviceConfigurationToCreate, CancellationToken cancellationToken)
        {
            this.ContentType = "application/json";
            this.Method = "POST";
        ...
        /// <param name="iosGeneralDeviceConfigurationToUpdate">The IosGeneralDeviceConfiguration to update.</param>
        /// <returns>The <see cref="GraphResponse{IosGeneralDeviceConfiguration}"/> object of the request.</returns>
        public System.Threading.Tasks.Task<GraphResponse<IosGeneralDeviceConfiguration>> UpdateResponseAsync(IosGeneralDeviceConfiguration iosGeneralDeviceConfigurationToUpdate)
        {
            return this.UpdateResponseAsync(iosGeneralDeviceConfigurationToUpdate, CancellationToken.None);
        }
        ...
        /// <exception cref="ClientException">Thrown when an object returned in a response is used for updating an object in Microsoft Graph.</exception>
        /// <returns>The <see cref="GraphResponse{IosGeneralDeviceConfiguration}"/> object of the request.</returns>
        public async System.Threading.Tasks.Task<GraphResponse<IosGeneralDeviceConfiguration>> UpdateResponseAsync(IosGeneralDeviceConfiguration iosGeneralDeviceConfigurationToUpdate, CancellationToken cancellationToken)
        {
			if (iosGeneralDeviceConfigurationToUpdate.AdditionalData != null)
			{
				if (iosGeneralDeviceConfigurationToUpdate.AdditionalData.ContainsKey(Constants.HttpPropertyNames.ResponseHeaders) ||
