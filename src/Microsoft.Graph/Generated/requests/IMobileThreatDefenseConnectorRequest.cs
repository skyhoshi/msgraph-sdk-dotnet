...
namespace Microsoft.Graph
{
    ...
    public partial interface IMobileThreatDefenseConnectorRequest : IBaseRequest
    {
        ...
        /// <param name="mobileThreatDefenseConnectorToUpdate">The MobileThreatDefenseConnector to update.</param>
        /// <returns>The <see cref="GraphResponse{MobileThreatDefenseConnector}"/> object of the request.</returns>
        System.Threading.Tasks.Task<GraphResponse<MobileThreatDefenseConnector>> UpdateResponseAsync(MobileThreatDefenseConnector mobileThreatDefenseConnectorToUpdate);
        ...
        /// <exception cref="ClientException">Thrown when an object returned in a response is used for updating an object in Microsoft Graph.</exception>
        /// <returns>The <see cref="GraphResponse{MobileThreatDefenseConnector}"/> object of the request.</returns>
        System.Threading.Tasks.Task<GraphResponse<MobileThreatDefenseConnector>> UpdateResponseAsync(MobileThreatDefenseConnector mobileThreatDefenseConnectorToUpdate, CancellationToken cancellationToken);
