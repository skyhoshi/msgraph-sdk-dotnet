...
namespace Microsoft.Graph
{
    ...
    public partial class WorkbookChartAxisTitleRequest : BaseRequest, IWorkbookChartAxisTitleRequest
    {
        ...
        public System.Threading.Tasks.Task<GraphResponse<WorkbookChartAxisTitle>> CreateResponseAsync(WorkbookChartAxisTitle workbookChartAxisTitleToCreate)
        {
            return this.CreateResponseAsync(workbookChartAxisTitleToCreate, CancellationToken.None);
        }
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The <see cref="GraphResponse{WorkbookChartAxisTitle}"/> object of the request.</returns>
        public async System.Threading.Tasks.Task<GraphResponse<WorkbookChartAxisTitle>> CreateResponseAsync(WorkbookChartAxisTitle workbookChartAxisTitleToCreate, CancellationToken cancellationToken)
        {
            this.ContentType = "application/json";
            this.Method = "POST";
        ...
        /// <param name="workbookChartAxisTitleToUpdate">The WorkbookChartAxisTitle to update.</param>
        /// <returns>The <see cref="GraphResponse{WorkbookChartAxisTitle}"/> object of the request.</returns>
        public System.Threading.Tasks.Task<GraphResponse<WorkbookChartAxisTitle>> UpdateResponseAsync(WorkbookChartAxisTitle workbookChartAxisTitleToUpdate)
        {
            return this.UpdateResponseAsync(workbookChartAxisTitleToUpdate, CancellationToken.None);
        }
        ...
        /// <exception cref="ClientException">Thrown when an object returned in a response is used for updating an object in Microsoft Graph.</exception>
        /// <returns>The <see cref="GraphResponse{WorkbookChartAxisTitle}"/> object of the request.</returns>
        public async System.Threading.Tasks.Task<GraphResponse<WorkbookChartAxisTitle>> UpdateResponseAsync(WorkbookChartAxisTitle workbookChartAxisTitleToUpdate, CancellationToken cancellationToken)
        {
			if (workbookChartAxisTitleToUpdate.AdditionalData != null)
			{
				if (workbookChartAxisTitleToUpdate.AdditionalData.ContainsKey(Constants.HttpPropertyNames.ResponseHeaders) ||
