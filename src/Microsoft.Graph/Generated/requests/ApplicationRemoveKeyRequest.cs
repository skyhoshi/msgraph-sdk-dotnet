...
namespace Microsoft.Graph
{
    ...
    /// </summary>
    public partial class ApplicationRemoveKeyRequest : BaseRequest, IApplicationRemoveKeyRequest
    {
        /// <summary>
        /// Constructs a new ApplicationRemoveKeyRequest.
        /// </summary>
        public ApplicationRemoveKeyRequest(
            string requestUrl,
            IBaseClient client,
            ...
            : base(requestUrl, client, options)
        {
            ...
            this.RequestBody = new ApplicationRemoveKeyRequestBody();
        }

        /// <summary>
        /// Gets the request body.
        /// </summary>
        public ApplicationRemoveKeyRequestBody RequestBody { get; private set; }
        ...
        public IApplicationRemoveKeyRequest Expand(string value)
        {
        ...
        /// <returns>The request object to send.</returns>
        public IApplicationRemoveKeyRequest Select(string value)
        {
