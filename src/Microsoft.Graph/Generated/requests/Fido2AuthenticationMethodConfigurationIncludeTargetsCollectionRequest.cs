...
namespace Microsoft.Graph
{
    ...
    public partial class Fido2AuthenticationMethodConfigurationIncludeTargetsCollectionRequest : BaseRequest, IFido2AuthenticationMethodConfigurationIncludeTargetsCollectionRequest
    {
        ...
        public System.Threading.Tasks.Task<GraphResponse<Fido2AuthenticationMethodConfigurationIncludeTargetsCollectionResponse>> GetResponseAsync()
        {
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The <see cref="GraphResponse{Fido2AuthenticationMethodConfigurationIncludeTargetsCollectionResponse}"/> object.</returns>
        public async System.Threading.Tasks.Task<GraphResponse<Fido2AuthenticationMethodConfigurationIncludeTargetsCollectionResponse>> GetResponseAsync(CancellationToken cancellationToken)
        {
            this.Method = "GET";
            return await this.SendAsyncWithGraphResponse<Fido2AuthenticationMethodConfigurationIncludeTargetsCollectionResponse>(null, cancellationToken).ConfigureAwait(false);
        }
