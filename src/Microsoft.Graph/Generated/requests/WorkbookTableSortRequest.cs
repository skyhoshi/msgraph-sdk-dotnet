...
namespace Microsoft.Graph
{
    ...
    public partial class WorkbookTableSortRequest : BaseRequest, IWorkbookTableSortRequest
    {
        ...
        /// </summary>
        /// <returns>The <see cref="GraphResponse{WorkbookTableSort}"/> object of the request.</returns>
        public System.Threading.Tasks.Task<GraphResponse<WorkbookTableSort>> GetResponseAsync()
        {
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The <see cref="GraphResponse{WorkbookTableSort}"/> object of the request.</returns>
        public async System.Threading.Tasks.Task<GraphResponse<WorkbookTableSort>> GetResponseAsync(CancellationToken cancellationToken)
        {
            this.Method = "GET";
            return await this.SendAsyncWithGraphResponse<WorkbookTableSort>(null, cancellationToken).ConfigureAwait(false);
        }
