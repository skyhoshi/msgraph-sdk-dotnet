...
namespace Microsoft.Graph
{
    ...
    public partial class SignInRequest : BaseRequest, ISignInRequest
    {
        ...
        /// <param name="signInToUpdate">The SignIn to update.</param>
        /// <returns>The <see cref="GraphResponse{SignIn}"/> object of the request.</returns>
        public System.Threading.Tasks.Task<GraphResponse<SignIn>> UpdateResponseAsync(SignIn signInToUpdate)
        {
            return this.UpdateResponseAsync(signInToUpdate, CancellationToken.None);
        }
        ...
        /// <exception cref="ClientException">Thrown when an object returned in a response is used for updating an object in Microsoft Graph.</exception>
        /// <returns>The <see cref="GraphResponse{SignIn}"/> object of the request.</returns>
        public async System.Threading.Tasks.Task<GraphResponse<SignIn>> UpdateResponseAsync(SignIn signInToUpdate, CancellationToken cancellationToken)
        {
			if (signInToUpdate.AdditionalData != null)
			{
				if (signInToUpdate.AdditionalData.ContainsKey(Constants.HttpPropertyNames.ResponseHeaders) ||
