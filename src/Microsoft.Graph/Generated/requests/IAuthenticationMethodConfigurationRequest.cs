...
namespace Microsoft.Graph
{
    ...
    public partial interface IAuthenticationMethodConfigurationRequest : IBaseRequest
    {
        ...
        System.Threading.Tasks.Task<AuthenticationMethodConfiguration> CreateAsync(AuthenticationMethodConfiguration authenticationMethodConfigurationToCreate);
        ...
        System.Threading.Tasks.Task<GraphResponse<AuthenticationMethodConfiguration>> CreateResponseAsync(AuthenticationMethodConfiguration authenticationMethodConfigurationToCreate);
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The <see cref="GraphResponse{AuthenticationMethodConfiguration}"/> object of the request.</returns>
        System.Threading.Tasks.Task<GraphResponse<AuthenticationMethodConfiguration>> CreateResponseAsync(AuthenticationMethodConfiguration authenticationMethodConfigurationToCreate, CancellationToken cancellationToken);
        ...
        /// <param name="authenticationMethodConfigurationToUpdate">The AuthenticationMethodConfiguration to update.</param>
        /// <returns>The <see cref="GraphResponse{AuthenticationMethodConfiguration}"/> object of the request.</returns>
        System.Threading.Tasks.Task<GraphResponse<AuthenticationMethodConfiguration>> UpdateResponseAsync(AuthenticationMethodConfiguration authenticationMethodConfigurationToUpdate);
        ...
        /// <exception cref="ClientException">Thrown when an object returned in a response is used for updating an object in Microsoft Graph.</exception>
        /// <returns>The <see cref="GraphResponse{AuthenticationMethodConfiguration}"/> object of the request.</returns>
        System.Threading.Tasks.Task<GraphResponse<AuthenticationMethodConfiguration>> UpdateResponseAsync(AuthenticationMethodConfiguration authenticationMethodConfigurationToUpdate, CancellationToken cancellationToken);
