...
namespace Microsoft.Graph
{
    ...
    public partial class TeamworkRequest : BaseRequest, ITeamworkRequest
    {
        ...
        public System.Threading.Tasks.Task<GraphResponse<Teamwork>> CreateResponseAsync(Teamwork teamworkToCreate)
        {
            return this.CreateResponseAsync(teamworkToCreate, CancellationToken.None);
        }
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The <see cref="GraphResponse{Teamwork}"/> object of the request.</returns>
        public async System.Threading.Tasks.Task<GraphResponse<Teamwork>> CreateResponseAsync(Teamwork teamworkToCreate, CancellationToken cancellationToken)
        {
            this.ContentType = "application/json";
            this.Method = "POST";
        ...
        /// <param name="teamworkToUpdate">The Teamwork to update.</param>
        /// <returns>The <see cref="GraphResponse{Teamwork}"/> object of the request.</returns>
        public System.Threading.Tasks.Task<GraphResponse<Teamwork>> UpdateResponseAsync(Teamwork teamworkToUpdate)
        {
            return this.UpdateResponseAsync(teamworkToUpdate, CancellationToken.None);
        }
        ...
        /// <exception cref="ClientException">Thrown when an object returned in a response is used for updating an object in Microsoft Graph.</exception>
        /// <returns>The <see cref="GraphResponse{Teamwork}"/> object of the request.</returns>
        public async System.Threading.Tasks.Task<GraphResponse<Teamwork>> UpdateResponseAsync(Teamwork teamworkToUpdate, CancellationToken cancellationToken)
        {
			if (teamworkToUpdate.AdditionalData != null)
			{
				if (teamworkToUpdate.AdditionalData.ContainsKey(Constants.HttpPropertyNames.ResponseHeaders) ||
