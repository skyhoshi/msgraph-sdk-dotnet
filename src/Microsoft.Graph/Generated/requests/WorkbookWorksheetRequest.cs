...
namespace Microsoft.Graph
{
    ...
    public partial class WorkbookWorksheetRequest : BaseRequest, IWorkbookWorksheetRequest
    {
        ...
        /// <param name="workbookWorksheetToUpdate">The WorkbookWorksheet to update.</param>
        /// <returns>The <see cref="GraphResponse{WorkbookWorksheet}"/> object of the request.</returns>
        public System.Threading.Tasks.Task<GraphResponse<WorkbookWorksheet>> UpdateResponseAsync(WorkbookWorksheet workbookWorksheetToUpdate)
        {
            return this.UpdateResponseAsync(workbookWorksheetToUpdate, CancellationToken.None);
        }
        ...
        /// <exception cref="ClientException">Thrown when an object returned in a response is used for updating an object in Microsoft Graph.</exception>
        /// <returns>The <see cref="GraphResponse{WorkbookWorksheet}"/> object of the request.</returns>
        public async System.Threading.Tasks.Task<GraphResponse<WorkbookWorksheet>> UpdateResponseAsync(WorkbookWorksheet workbookWorksheetToUpdate, CancellationToken cancellationToken)
        {
			if (workbookWorksheetToUpdate.AdditionalData != null)
			{
				if (workbookWorksheetToUpdate.AdditionalData.ContainsKey(Constants.HttpPropertyNames.ResponseHeaders) ||
