...
namespace Microsoft.Graph
{
    ...
    public partial class ReferenceAttachmentRequest : BaseRequest, IReferenceAttachmentRequest
    {
        ...
        /// </summary>
        /// <returns>The <see cref="GraphResponse{ReferenceAttachment}"/> object of the request.</returns>
        public System.Threading.Tasks.Task<GraphResponse<ReferenceAttachment>> GetResponseAsync()
        {
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The <see cref="GraphResponse{ReferenceAttachment}"/> object of the request.</returns>
        public async System.Threading.Tasks.Task<GraphResponse<ReferenceAttachment>> GetResponseAsync(CancellationToken cancellationToken)
        {
            this.Method = "GET";
            return await this.SendAsyncWithGraphResponse<ReferenceAttachment>(null, cancellationToken).ConfigureAwait(false);
        }
