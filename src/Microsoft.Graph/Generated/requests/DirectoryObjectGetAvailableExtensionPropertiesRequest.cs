...
namespace Microsoft.Graph
{
    ...
    public partial class DirectoryObjectGetAvailableExtensionPropertiesRequest : BaseRequest, IDirectoryObjectGetAvailableExtensionPropertiesRequest
    {
        ...
        public async System.Threading.Tasks.Task<GraphResponse<DirectoryObjectGetAvailableExtensionPropertiesCollectionResponse>> PostResponseAsync(CancellationToken cancellationToken = default(CancellationToken))
        {
            this.Method = "POST";
            return await this.SendAsyncWithGraphResponse<DirectoryObjectGetAvailableExtensionPropertiesCollectionResponse>(this.RequestBody, cancellationToken).ConfigureAwait(false);
        }
