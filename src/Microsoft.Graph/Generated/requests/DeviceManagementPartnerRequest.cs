...
namespace Microsoft.Graph
{
    ...
    public partial class DeviceManagementPartnerRequest : BaseRequest, IDeviceManagementPartnerRequest
    {
        ...
        /// </summary>
        /// <returns>The <see cref="GraphResponse{DeviceManagementPartner}"/> object of the request.</returns>
        public System.Threading.Tasks.Task<GraphResponse<DeviceManagementPartner>> GetResponseAsync()
        {
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The <see cref="GraphResponse{DeviceManagementPartner}"/> object of the request.</returns>
        public async System.Threading.Tasks.Task<GraphResponse<DeviceManagementPartner>> GetResponseAsync(CancellationToken cancellationToken)
        {
            this.Method = "GET";
            return await this.SendAsyncWithGraphResponse<DeviceManagementPartner>(null, cancellationToken).ConfigureAwait(false);
        }
