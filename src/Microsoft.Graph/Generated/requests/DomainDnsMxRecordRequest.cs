...
namespace Microsoft.Graph
{
    ...
    public partial class DomainDnsMxRecordRequest : BaseRequest, IDomainDnsMxRecordRequest
    {
        ...
        /// </summary>
        /// <returns>The <see cref="GraphResponse{DomainDnsMxRecord}"/> object of the request.</returns>
        public System.Threading.Tasks.Task<GraphResponse<DomainDnsMxRecord>> GetResponseAsync()
        {
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The <see cref="GraphResponse{DomainDnsMxRecord}"/> object of the request.</returns>
        public async System.Threading.Tasks.Task<GraphResponse<DomainDnsMxRecord>> GetResponseAsync(CancellationToken cancellationToken)
        {
            this.Method = "GET";
            return await this.SendAsyncWithGraphResponse<DomainDnsMxRecord>(null, cancellationToken).ConfigureAwait(false);
        }
