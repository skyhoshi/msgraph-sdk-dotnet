...
namespace Microsoft.Graph
{
    ...
    public partial class OpenShiftChangeRequestRequest : BaseRequest, IOpenShiftChangeRequestRequest
    {
        ...
        public System.Threading.Tasks.Task<GraphResponse<OpenShiftChangeRequestObject>> CreateResponseAsync(OpenShiftChangeRequestObject openShiftChangeRequestObjectToCreate)
        {
            return this.CreateResponseAsync(openShiftChangeRequestObjectToCreate, CancellationToken.None);
        }
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The <see cref="GraphResponse{OpenShiftChangeRequestObject}"/> object of the request.</returns>
        public async System.Threading.Tasks.Task<GraphResponse<OpenShiftChangeRequestObject>> CreateResponseAsync(OpenShiftChangeRequestObject openShiftChangeRequestObjectToCreate, CancellationToken cancellationToken)
        {
            this.ContentType = "application/json";
            this.Method = "POST";
        ...
        /// <param name="openShiftChangeRequestObjectToUpdate">The OpenShiftChangeRequestObject to update.</param>
        /// <returns>The <see cref="GraphResponse{OpenShiftChangeRequestObject}"/> object of the request.</returns>
        public System.Threading.Tasks.Task<GraphResponse<OpenShiftChangeRequestObject>> UpdateResponseAsync(OpenShiftChangeRequestObject openShiftChangeRequestObjectToUpdate)
        {
            return this.UpdateResponseAsync(openShiftChangeRequestObjectToUpdate, CancellationToken.None);
        }
        ...
        /// <exception cref="ClientException">Thrown when an object returned in a response is used for updating an object in Microsoft Graph.</exception>
        /// <returns>The <see cref="GraphResponse{OpenShiftChangeRequestObject}"/> object of the request.</returns>
        public async System.Threading.Tasks.Task<GraphResponse<OpenShiftChangeRequestObject>> UpdateResponseAsync(OpenShiftChangeRequestObject openShiftChangeRequestObjectToUpdate, CancellationToken cancellationToken)
        {
			if (openShiftChangeRequestObjectToUpdate.AdditionalData != null)
			{
				if (openShiftChangeRequestObjectToUpdate.AdditionalData.ContainsKey(Constants.HttpPropertyNames.ResponseHeaders) ||
