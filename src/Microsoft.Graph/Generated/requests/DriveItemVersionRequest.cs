...
namespace Microsoft.Graph
{
    ...
    public partial class DriveItemVersionRequest : BaseRequest, IDriveItemVersionRequest
    {
        ...
        public System.Threading.Tasks.Task<GraphResponse<DriveItemVersion>> CreateResponseAsync(DriveItemVersion driveItemVersionToCreate)
        {
            return this.CreateResponseAsync(driveItemVersionToCreate, CancellationToken.None);
        }
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The <see cref="GraphResponse{DriveItemVersion}"/> object of the request.</returns>
        public async System.Threading.Tasks.Task<GraphResponse<DriveItemVersion>> CreateResponseAsync(DriveItemVersion driveItemVersionToCreate, CancellationToken cancellationToken)
        {
            this.ContentType = "application/json";
            this.Method = "POST";
        ...
        /// <param name="driveItemVersionToUpdate">The DriveItemVersion to update.</param>
        /// <returns>The <see cref="GraphResponse{DriveItemVersion}"/> object of the request.</returns>
        public System.Threading.Tasks.Task<GraphResponse<DriveItemVersion>> UpdateResponseAsync(DriveItemVersion driveItemVersionToUpdate)
        {
            return this.UpdateResponseAsync(driveItemVersionToUpdate, CancellationToken.None);
        }
        ...
        /// <exception cref="ClientException">Thrown when an object returned in a response is used for updating an object in Microsoft Graph.</exception>
        /// <returns>The <see cref="GraphResponse{DriveItemVersion}"/> object of the request.</returns>
        public async System.Threading.Tasks.Task<GraphResponse<DriveItemVersion>> UpdateResponseAsync(DriveItemVersion driveItemVersionToUpdate, CancellationToken cancellationToken)
        {
			if (driveItemVersionToUpdate.AdditionalData != null)
			{
				if (driveItemVersionToUpdate.AdditionalData.ContainsKey(Constants.HttpPropertyNames.ResponseHeaders) ||
