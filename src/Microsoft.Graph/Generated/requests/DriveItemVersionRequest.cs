...
namespace Microsoft.Graph
{
    ...
    public partial class DriveItemVersionRequest : BaseRequest, IDriveItemVersionRequest
    {
        ...
        /// </summary>
        /// <returns>The <see cref="GraphResponse{DriveItemVersion}"/> object of the request.</returns>
        public System.Threading.Tasks.Task<GraphResponse<DriveItemVersion>> GetResponseAsync()
        {
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The <see cref="GraphResponse{DriveItemVersion}"/> object of the request.</returns>
        public async System.Threading.Tasks.Task<GraphResponse<DriveItemVersion>> GetResponseAsync(CancellationToken cancellationToken)
        {
            this.Method = "GET";
            return await this.SendAsyncWithGraphResponse<DriveItemVersion>(null, cancellationToken).ConfigureAwait(false);
        }
