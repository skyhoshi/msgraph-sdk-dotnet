...
namespace Microsoft.Graph
{
    ...
    public partial interface IManagedEBookDeviceStatesCollectionRequest : IBaseRequest
    {
        ...
        System.Threading.Tasks.Task<GraphResponse<ManagedEBookDeviceStatesCollectionResponse>> GetResponseAsync();
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The <see cref="GraphResponse{ManagedEBookDeviceStatesCollectionResponse}"/> object.</returns>
        System.Threading.Tasks.Task<GraphResponse<ManagedEBookDeviceStatesCollectionResponse>> GetResponseAsync(CancellationToken cancellationToken);
