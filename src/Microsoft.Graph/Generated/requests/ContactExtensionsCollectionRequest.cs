...
namespace Microsoft.Graph
{
    ...
    public partial class ContactExtensionsCollectionRequest : BaseRequest, IContactExtensionsCollectionRequest
    {
        ...
        public async System.Threading.Tasks.Task<IContactExtensionsCollectionPage> GetAsync(CancellationToken cancellationToken = default(CancellationToken))
        {
            this.Method = "GET";
        ...
        public async System.Threading.Tasks.Task<GraphResponse<ContactExtensionsCollectionResponse>> GetResponseAsync(CancellationToken cancellationToken = default(CancellationToken))
        {
            this.Method = "GET";
            return await this.SendAsyncWithGraphResponse<ContactExtensionsCollectionResponse>(null, cancellationToken).ConfigureAwait(false);
        }
