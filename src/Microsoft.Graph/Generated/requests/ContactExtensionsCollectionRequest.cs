...
namespace Microsoft.Graph
{
    ...
    public partial class ContactExtensionsCollectionRequest : BaseRequest, IContactExtensionsCollectionRequest
    {
        ...
        public System.Threading.Tasks.Task<GraphResponse<ContactExtensionsCollectionResponse>> GetResponseAsync()
        {
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The <see cref="GraphResponse{ContactExtensionsCollectionResponse}"/> object.</returns>
        public async System.Threading.Tasks.Task<GraphResponse<ContactExtensionsCollectionResponse>> GetResponseAsync(CancellationToken cancellationToken)
        {
            this.Method = "GET";
