...
namespace Microsoft.Graph
{
    ...
    public partial class OutlookItemRequest : BaseRequest, IOutlookItemRequest
    {
        ...
        public System.Threading.Tasks.Task<GraphResponse<OutlookItem>> CreateResponseAsync(OutlookItem outlookItemToCreate)
        {
            return this.CreateResponseAsync(outlookItemToCreate, CancellationToken.None);
        }
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The <see cref="GraphResponse{OutlookItem}"/> object of the request.</returns>
        public async System.Threading.Tasks.Task<GraphResponse<OutlookItem>> CreateResponseAsync(OutlookItem outlookItemToCreate, CancellationToken cancellationToken)
        {
            this.ContentType = "application/json";
            this.Method = "POST";
            return await this.SendAsyncWithGraphResponse<OutlookItem>(outlookItemToCreate, cancellationToken).ConfigureAwait(false);
        }
        ...
        /// <param name="outlookItemToUpdate">The OutlookItem to update.</param>
        /// <returns>The <see cref="GraphResponse{OutlookItem}"/> object of the request.</returns>
        public System.Threading.Tasks.Task<GraphResponse<OutlookItem>> UpdateResponseAsync(OutlookItem outlookItemToUpdate)
        {
            return this.UpdateResponseAsync(outlookItemToUpdate, CancellationToken.None);
        }
        ...
        /// <exception cref="ClientException">Thrown when an object returned in a response is used for updating an object in Microsoft Graph.</exception>
        /// <returns>The <see cref="GraphResponse{OutlookItem}"/> object of the request.</returns>
        public async System.Threading.Tasks.Task<GraphResponse<OutlookItem>> UpdateResponseAsync(OutlookItem outlookItemToUpdate, CancellationToken cancellationToken)
        {
			if (outlookItemToUpdate.AdditionalData != null)
			{
				if (outlookItemToUpdate.AdditionalData.ContainsKey(Constants.HttpPropertyNames.ResponseHeaders) ||
            ...
            this.ContentType = "application/json";
            this.Method = "PATCH";
            return await this.SendAsyncWithGraphResponse<OutlookItem>(outlookItemToUpdate, cancellationToken).ConfigureAwait(false);
        }
