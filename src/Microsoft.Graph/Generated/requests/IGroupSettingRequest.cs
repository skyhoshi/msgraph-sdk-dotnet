...
namespace Microsoft.Graph
{
    ...
    public partial interface IGroupSettingRequest : IBaseRequest
    {
        ...
        /// <param name="groupSettingToUpdate">The GroupSetting to update.</param>
        /// <returns>The <see cref="GraphResponse{GroupSetting}"/> object of the request.</returns>
        System.Threading.Tasks.Task<GraphResponse<GroupSetting>> UpdateResponseAsync(GroupSetting groupSettingToUpdate);
        ...
        /// <exception cref="ClientException">Thrown when an object returned in a response is used for updating an object in Microsoft Graph.</exception>
        /// <returns>The <see cref="GraphResponse{GroupSetting}"/> object of the request.</returns>
        System.Threading.Tasks.Task<GraphResponse<GroupSetting>> UpdateResponseAsync(GroupSetting groupSettingToUpdate, CancellationToken cancellationToken);
