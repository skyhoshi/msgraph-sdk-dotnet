...
namespace Microsoft.Graph
{
    ...
    /// </summary>
    public partial class ServicePrincipalAddKeyRequestBuilder : BaseActionMethodRequestBuilder<IServicePrincipalAddKeyRequest>, IServicePrincipalAddKeyRequestBuilder
    {
        /// <summary>
        ...
        protected override IServicePrincipalAddKeyRequest CreateRequest(string functionUrl, IEnumerable<Option> options)
        {
            var request = new ServicePrincipalAddKeyRequest(functionUrl, this.Client, options);
