...
namespace Microsoft.Graph
{
    ...
    public partial interface IEmailAuthenticationMethodConfigurationIncludeTargetsCollectionRequest : IBaseRequest
    {
        ...
        System.Threading.Tasks.Task<GraphResponse<AuthenticationMethodTarget>> AddResponseAsync(AuthenticationMethodTarget authenticationMethodTarget);
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The <see cref="GraphResponse{AuthenticationMethodTarget}"/> object of the request.</returns>
        System.Threading.Tasks.Task<GraphResponse<AuthenticationMethodTarget>> AddResponseAsync(AuthenticationMethodTarget authenticationMethodTarget, CancellationToken cancellationToken);
        ...
        System.Threading.Tasks.Task<GraphResponse<EmailAuthenticationMethodConfigurationIncludeTargetsCollectionResponse>> GetResponseAsync();
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The <see cref="GraphResponse{EmailAuthenticationMethodConfigurationIncludeTargetsCollectionResponse}"/> object.</returns>
        System.Threading.Tasks.Task<GraphResponse<EmailAuthenticationMethodConfigurationIncludeTargetsCollectionResponse>> GetResponseAsync(CancellationToken cancellationToken);
