...
namespace Microsoft.Graph
{
    ...
    public partial class OutlookUserRequest : BaseRequest, IOutlookUserRequest
    {
        ...
        public System.Threading.Tasks.Task<GraphResponse<OutlookUser>> CreateResponseAsync(OutlookUser outlookUserToCreate)
        {
            return this.CreateResponseAsync(outlookUserToCreate, CancellationToken.None);
        }
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The <see cref="GraphResponse{OutlookUser}"/> object of the request.</returns>
        public async System.Threading.Tasks.Task<GraphResponse<OutlookUser>> CreateResponseAsync(OutlookUser outlookUserToCreate, CancellationToken cancellationToken)
        {
            this.ContentType = "application/json";
            this.Method = "POST";
        ...
        /// <param name="outlookUserToUpdate">The OutlookUser to update.</param>
        /// <returns>The <see cref="GraphResponse{OutlookUser}"/> object of the request.</returns>
        public System.Threading.Tasks.Task<GraphResponse<OutlookUser>> UpdateResponseAsync(OutlookUser outlookUserToUpdate)
        {
            return this.UpdateResponseAsync(outlookUserToUpdate, CancellationToken.None);
        }
        ...
        /// <exception cref="ClientException">Thrown when an object returned in a response is used for updating an object in Microsoft Graph.</exception>
        /// <returns>The <see cref="GraphResponse{OutlookUser}"/> object of the request.</returns>
        public async System.Threading.Tasks.Task<GraphResponse<OutlookUser>> UpdateResponseAsync(OutlookUser outlookUserToUpdate, CancellationToken cancellationToken)
        {
			if (outlookUserToUpdate.AdditionalData != null)
			{
				if (outlookUserToUpdate.AdditionalData.ContainsKey(Constants.HttpPropertyNames.ResponseHeaders) ||
