...
namespace Microsoft.Graph
{
    ...
    public partial class OAuth2PermissionGrantReferenceRequest : BaseRequest, IOAuth2PermissionGrantReferenceRequest
    {
        ...
        /// <summary>
        /// Deletes the specified OAuth2PermissionGrant reference and returns a <see cref="GraphResponse"/> object.
        /// </summary>
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        ...
        /// <summary>
        /// Puts the specified OAuth2PermissionGrant reference and returns <see cref="GraphResponse"/> object.
        /// </summary>
        /// <param name="id">The OAuth2PermissionGrant reference to update.</param>
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
