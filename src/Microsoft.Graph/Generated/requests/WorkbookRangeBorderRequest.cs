...
namespace Microsoft.Graph
{
    ...
    public partial class WorkbookRangeBorderRequest : BaseRequest, IWorkbookRangeBorderRequest
    {
        ...
        /// </summary>
        /// <returns>The <see cref="GraphResponse{WorkbookRangeBorder}"/> object of the request.</returns>
        public System.Threading.Tasks.Task<GraphResponse<WorkbookRangeBorder>> GetResponseAsync()
        {
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The <see cref="GraphResponse{WorkbookRangeBorder}"/> object of the request.</returns>
        public async System.Threading.Tasks.Task<GraphResponse<WorkbookRangeBorder>> GetResponseAsync(CancellationToken cancellationToken)
        {
            this.Method = "GET";
