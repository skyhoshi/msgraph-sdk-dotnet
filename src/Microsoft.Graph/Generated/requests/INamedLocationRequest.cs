...
namespace Microsoft.Graph
{
    ...
    public partial interface INamedLocationRequest : IBaseRequest
    {
        ...
        /// <param name="namedLocationToUpdate">The NamedLocation to update.</param>
        /// <returns>The <see cref="GraphResponse{NamedLocation}"/> object of the request.</returns>
        System.Threading.Tasks.Task<GraphResponse<NamedLocation>> UpdateResponseAsync(NamedLocation namedLocationToUpdate);
        ...
        /// <exception cref="ClientException">Thrown when an object returned in a response is used for updating an object in Microsoft Graph.</exception>
        /// <returns>The <see cref="GraphResponse{NamedLocation}"/> object of the request.</returns>
        System.Threading.Tasks.Task<GraphResponse<NamedLocation>> UpdateResponseAsync(NamedLocation namedLocationToUpdate, CancellationToken cancellationToken);
