...
namespace Microsoft.Graph
{
    ...
    public partial interface IWorkbookFunctionsRequest : IBaseRequest
    {
        ...
        /// <param name="workbookFunctionsToUpdate">The WorkbookFunctions to update.</param>
        /// <returns>The <see cref="GraphResponse{WorkbookFunctions}"/> object of the request.</returns>
        System.Threading.Tasks.Task<GraphResponse<WorkbookFunctions>> UpdateResponseAsync(WorkbookFunctions workbookFunctionsToUpdate);
        ...
        /// <exception cref="ClientException">Thrown when an object returned in a response is used for updating an object in Microsoft Graph.</exception>
        /// <returns>The <see cref="GraphResponse{WorkbookFunctions}"/> object of the request.</returns>
        System.Threading.Tasks.Task<GraphResponse<WorkbookFunctions>> UpdateResponseAsync(WorkbookFunctions workbookFunctionsToUpdate, CancellationToken cancellationToken);
