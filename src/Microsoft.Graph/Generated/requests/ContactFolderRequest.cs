...
namespace Microsoft.Graph
{
    ...
    public partial class ContactFolderRequest : BaseRequest, IContactFolderRequest
    {
        ...
        /// </summary>
        /// <returns>The <see cref="GraphResponse{ContactFolder}"/> object of the request.</returns>
        public System.Threading.Tasks.Task<GraphResponse<ContactFolder>> GetResponseAsync()
        {
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The <see cref="GraphResponse{ContactFolder}"/> object of the request.</returns>
        public async System.Threading.Tasks.Task<GraphResponse<ContactFolder>> GetResponseAsync(CancellationToken cancellationToken)
        {
            this.Method = "GET";
            return await this.SendAsyncWithGraphResponse<ContactFolder>(null, cancellationToken).ConfigureAwait(false);
        }
