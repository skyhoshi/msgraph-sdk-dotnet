...
namespace Microsoft.Graph
{
    ...
    public partial class OnenoteResourceRequest : BaseRequest, IOnenoteResourceRequest
    {
        ...
        public System.Threading.Tasks.Task<GraphResponse<OnenoteResource>> CreateResponseAsync(OnenoteResource onenoteResourceToCreate)
        {
            return this.CreateResponseAsync(onenoteResourceToCreate, CancellationToken.None);
        }
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> for the request.</param>
        /// <returns>The <see cref="GraphResponse{OnenoteResource}"/> object of the request.</returns>
        public async System.Threading.Tasks.Task<GraphResponse<OnenoteResource>> CreateResponseAsync(OnenoteResource onenoteResourceToCreate, CancellationToken cancellationToken)
        {
            this.ContentType = "application/json";
            this.Method = "POST";
        ...
        /// <param name="onenoteResourceToUpdate">The OnenoteResource to update.</param>
        /// <returns>The <see cref="GraphResponse{OnenoteResource}"/> object of the request.</returns>
        public System.Threading.Tasks.Task<GraphResponse<OnenoteResource>> UpdateResponseAsync(OnenoteResource onenoteResourceToUpdate)
        {
            return this.UpdateResponseAsync(onenoteResourceToUpdate, CancellationToken.None);
        }
        ...
        /// <exception cref="ClientException">Thrown when an object returned in a response is used for updating an object in Microsoft Graph.</exception>
        /// <returns>The <see cref="GraphResponse{OnenoteResource}"/> object of the request.</returns>
        public async System.Threading.Tasks.Task<GraphResponse<OnenoteResource>> UpdateResponseAsync(OnenoteResource onenoteResourceToUpdate, CancellationToken cancellationToken)
        {
			if (onenoteResourceToUpdate.AdditionalData != null)
			{
				if (onenoteResourceToUpdate.AdditionalData.ContainsKey(Constants.HttpPropertyNames.ResponseHeaders) ||
